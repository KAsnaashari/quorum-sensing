...
do
    ...
    $GMX/gmx grompp -f $MDP/em_steep_$LAMBDA.mdp -c $FREE_ENERGY/OHN_solv.gro -p $FREE_ENERGY/topol.top -o min$LAMBDA.tpr

    $GMX/gmx mdrun -v -deffnm min$LAMBDA
    ...
    $GMX/gmx mdrun -v -deffnm nvt$LAMBDA
    ...
    $GMX/gmx mdrun -v -deffnm npt$LAMBDA
    ...
    $GMX/gmx mdrun -v -deffnm md$LAMBDA
